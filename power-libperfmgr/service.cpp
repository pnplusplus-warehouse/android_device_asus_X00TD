...
int main() {
    LOG(INFO) << "Asus SDM660 Power HAL AIDL Service is starting.";
    ...
    LOG(INFO) << "Asus SDM660 Power HAL AIDL Service is started.";

    ABinderProcess_joinThreadPool();
    LOG(ERROR) << "Asus SDM660 Power HAL AIDL Service died.";
